# -*- coding: utf-8 -*-
#Python static class "Harmonica Tab Interface Chooser". Contains convenient endpoints that allow detection and interaction with several version-specific harmonica tab interfaces. Copyright (C) 2024 Anna Anikina
#
