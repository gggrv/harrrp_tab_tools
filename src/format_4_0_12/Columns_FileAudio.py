# -*- coding: utf-8 -*-
#Python static class "Interface to Metadata Block File/AudioAttachment v4.0.12". Defines necessary metadata fields and relevant functionality. Copyright (C) 2024 Anna Anikina
#
